...
if (window.innerHeight > window.innerWidth) {
	(0, _jquery2['default'])('canvas').css('visibility', 'hidden');
	(0, _jquery2['default'])('#turn').css('visibility', 'visible');
} else {
	GENEVA = new Game();
	(0, _jquery2['default'])('#turn').css('visibility', 'hidden');
}
...
(0, _jquery2['default'])(window).on('resize', function () {
	if (window.innerHeight > window.innerWidth) {
		if (GENEVA) {
			...
			(0, _jquery2['default'])('canvas').css('visibility', 'visible');
			(0, _jquery2['default'])('#turn').css('visibility', 'hidden');
		}
	} else {
		if (GENEVA) {
...
var LifeManager = (function (_Phaser$Sprite) {
	...
	function LifeManager(game, x, y, key, frame, characterHealth) {
		_classCallCheck(this, LifeManager);

		_get(Object.getPrototypeOf(LifeManager.prototype), "constructor", this).call(this, game, x, y, key, frame);
		this.game = game;
...
var Intro = (function (_Phaser$State) {
	...
	_createClass(Intro, [{
		...
		value: function create() {
			...
			this.page = 0;
			this.text = this.game.add.text((0, _jquery2['default'])('canvas').width() / 2, (0, _jquery2['default'])('canvas').height() / 2 - 30, texts[0], {
				font: "Minecraft",
				fontSize: 18,
				fill: 'white',
				align: 'left',
